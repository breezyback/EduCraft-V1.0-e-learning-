        ...
        <div class="container" style="background-color: white; box-shadow: 4px 4px 10px 0px rgb(0, 0, 0, 0.25);">
                ...
                <div class="col p-4">
                    <div class="row pt-3 pb-3">
                        <div class="col-8 text-center">
                            <a class="btn rounded-pill mr-5" href="{{ route('admin.show_courses_list') }}"  style="width: 8vw; background-color: #0E153A; color: white;">Courses list</a>
                    ...
                    <div class="row mt-4">
                        <div class="col-8 text-center">
                            <h3 style="font: 500 3vw 'Roboto'; color: #0E153A;">Courses List</h3>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/course/{{ $course->cr_id }}">{{ $course->cr_n }}</a>
                                        </td>
                                        <td>{{ $course->cr_desc }}</td>
                                        <td>{{ $course->tch_n}}</td>
                                        <td>{{ $course->cr_cr_at }}</td>
                                        <td>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $course->cr_id }}">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <!-- Modal Delete -->
                    <div class="modal fade" id="deleteModal{{ $course->cr_id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="/admin/courses/delete/{{ $course->cr_id }}" method="POST">
                                    @csrf
                                    @method('delete')
