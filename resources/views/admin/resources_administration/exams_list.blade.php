        ...
        <div class="container" style="background-color: white; box-shadow: 4px 4px 10px 0px rgb(0, 0, 0, 0.25);">
                ...
                <div class="col p-4">
                    <div class="row pt-3 pb-3">
                        <div class="col-8 text-center">
                            ...
                            <a class="btn rounded-pill mr-5" href="{{ route('admin.show_exams_list') }}" style="width: 8vw; background-color: #0E153A; color: white;">Exams list</a>
                            <a class="btn rounded-pill create" href="{{ route('admin.show_tps_list') }}" style="width: 8vw;">Tps list</a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-8 text-center">
                            <h3 style="font: 500 3vw 'Roboto'; color: #0E153A;">Exams List</h3>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $examen->ex_n }}</td>
                                        <td>{{ $examen->duration }} hours</td>
                                        <td>{{ $examen->open_date }}</td>
                                        <td>{{ $examen->open_hour }}</td>
                                        <td>{{ $examen->tch_n }}</td>
                                        <td>{{ $examen->ex_cr_at }}</td>
                                        <td>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $examen->ex_id }}">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <!-- Modal Delete -->
                    <div class="modal fade" id="deleteModal{{ $examen->ex_id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="/admin/exams/delete/{{ $examen->ex_id }}" method="POST">
                                    @csrf
                                    @method('delete')
