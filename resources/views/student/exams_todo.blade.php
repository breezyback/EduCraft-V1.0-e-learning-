...
@section('content')
    <div class="container-fluid" style="background-color: rgb(67, 83, 167, 0.82);">
        <div class="row" style="padding: 10px;">
            <div class="col-sm-7">
                <h1 class="p-4 m-0" style="color: white; font-family: 'Roboto'; font-size: 4.6vw;">Exams List</h1>
            </div>
            <div class="col-auto">
            ...
            <div class="col" style="max-width: 100%;">
                ...
                <div class="row pb-3 p-5">
                    <div class="col-auto text-center" style=";">
                        <h2 class="display-4" style="font-family: Roboto; color: #0E153A">My Exams</h2>
                    </div>
                </div>
                        ...
                        <div class="col-auto mb-4">
                            <div class="card" style="width: 15rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/student/pass/exams/{{ $ex->id }}" class="btn btn-primary">Details</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
