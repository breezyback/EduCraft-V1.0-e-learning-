                ...
                <div class="col">
                    <div class="row pl-5 pr-5 pt-4 pb-5 align-items-center">
                        ...
                        <div class="col p-0 cr_nav">
                            <a class="btn" href="{{ route('teacher.show_all_exams_solutions') }}" style="background-color: #0E153A; color: white;">Exams Solutions</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="row pl-4">
                                <div class="col-7">
                                    <h2 style="color: #0E153A; font: 700 2.8vw 'Roboto';">Exams</h2>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="row pl-3 pr-3 pt-4">
                                        <div class="col" style="border-radius: 20px;">
                                            <div class="row">
                                                <div class="col">
                                                    <h4 style="font: 700 1.5vw 'Roboto';">{{$examen_name}}</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pl-4 pr-4 pt-2">
                                                <div class="col p-0">
                                                    <table class="table table-hover">
                                                        ...
                                                        @if($data->examens_name == $examen_name)
                                                        <tbody>
                                                            <tr class="table-success">
                                                                ...
                                                                @else
                                                                    <td>Evaluated</td>
                                                                @endif
                                                                <td><a class="btn-sm btn-warning rounded-pill" href="/teacher/solutions/exams/details/{{ $data->resex_id }}?us={{ $data->us_id }}">Evaluer</a></td>
                                                            </tr>
                                                        </tbody>
                                                        @endif
                                                        @endforeach
